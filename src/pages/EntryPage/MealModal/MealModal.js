...
const MealModal = ({mState, show, mode, onCancel, handleSaveSubmit, dispatch}) => {
    ...
    const handleStateChange = (key, value) => dispatch(
        {type: 'STATE_CHANGE', payload: {key, value}}
    );
    ...
    return <div className={`${classes.container} ${show ? classes.show : ''}`}>
        <h1>{mode} Meal</h1>
        <TimePicker
            time={time}
        ...
        <div className={classes.foodList}>
            ...
            >
                ...
                <div className={classes.form_btn_container}>
                    <button 
                        type='button'
                        className={`${classes.g_btn} ${loading ? classes.g_disabled: ''}`}
        ...
        <div className={classes.end_btn}>
            ...
            <button 
                type='button' 
                className={`${foods.length === 0 ? classes.save_disabled : classes.save}`}
